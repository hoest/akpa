...
function akpaholland_register_theme_menu() {
  register_nav_menu('primary', 'Hoofdnavigatie');
}

add_action('init', 'akpaholland_register_theme_menu');

function akpaholland_init() {
...
add_action('widgets_init', 'akpaholland_init');
